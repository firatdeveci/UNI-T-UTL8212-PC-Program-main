...
namespace UNI_T_UTL8212		// Gauge_Demo yerine o anki projenin namespace ismi yazılacak
{
    public class SevenSegment : UserControl
    {
                    ...
                    if (!success)
                    {
                        try
                        {
                            ...
                            switch (tempString.ToLower()[0])
                            {
                                ...
                                case '*': customPattern = (int)ValuePattern.Asterisk; break;
        ...
        private void InitializeComponent()
        {
            ...
            // 
            this.Name = "SevenSegment";
            this.Size = new System.Drawing.Size(83, 110);
            this.ResumeLayout(false);
